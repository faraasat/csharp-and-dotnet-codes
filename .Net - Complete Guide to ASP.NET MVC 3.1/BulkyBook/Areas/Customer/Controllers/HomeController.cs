...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        [Authorize]  // User must be signed in to add any thing to cart
        public IActionResult Details(ShoppingCart CartObject)
        {
            ...
            if(ModelState.IsValid)
            {
                ...
                // HttpContext.Session.SetObject(StaticDetails.ssShoppingCart, count);  // This is session implementation of custom class SessionExtension.cs
