...
namespace BulkyBook.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        // This is required because we are uploading images to wwwroot 
        ...
        public async Task<IActionResult> Upsert(ProductVM productVM)
        {
            ...
            if (abc)
            {
                ...
                if (files.Count > 0)
                {
                    ...
                    {
                        // This means this is an edit and we need to remove old one
                ...
                {
                    // For Update when they donot change the image
